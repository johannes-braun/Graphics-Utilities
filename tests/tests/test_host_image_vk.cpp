...
TEST_CASE_METHOD(context_provider, "Image load/store", "[image]")
{
...
TEST_CASE_METHOD(context_provider, "Image operations", "[image]")
{
    const glm::vec4   pixel_value{1.f, 0.4f, 0.22f, 103878.f};
    const glm::uvec3  pixel{9, 3, 5};
    const gfx::extent size(10, 4, 7);
...
TEST_CASE_METHOD(context_provider, "Image conversion", "[image]")
{
    const glm::vec4   pixel_value{1.f, 0.4f, 0.22f, 103878.f};
    const glm::uvec3  pixel{9, 3, 5};
    const gfx::extent size(10, 4, 7);
