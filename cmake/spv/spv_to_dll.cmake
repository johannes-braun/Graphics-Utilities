...
function(add_shader SPVGEN_LIB_NAME)
	...
	foreach(SPVGEN_CURRENT_FILE ${ARGV})
		...
		ADD_CUSTOM_COMMAND(OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/CMakeFiles/${SPVGEN_CURRENT_FILE}.${SPVGEN_LIB_NAME}.hpp
			COMMAND ${CMAKE_COMMAND} 
				...
				-DSPVGEN_HEADER=${CMAKE_CURRENT_BINARY_DIR}/CMakeFiles/${SPVGEN_CURRENT_FILE}.${SPVGEN_LIB_NAME}.hpp
				-P ${SPVGEN_CURRENT_DIR}/compile.cmake
			DEPENDS ${FILE_DEPENDENCY_LIST} ${CMAKE_CURRENT_BINARY_DIR}/CMakeFiles/${SPVGEN_CURRENT_FILE}.${SPVGEN_LIB_NAME}.hpp.in
		)
		list(APPEND SPVGEN_DEPENDENT_HEADERS ${CMAKE_CURRENT_BINARY_DIR}/CMakeFiles/${SPVGEN_CURRENT_FILE}.${SPVGEN_LIB_NAME}.hpp)
	endforeach()
