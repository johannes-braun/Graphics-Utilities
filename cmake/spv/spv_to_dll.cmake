...
function(add_shader SPVGEN_LIB_NAME)
	...
	file(WRITE ${CMAKE_CURRENT_BINARY_DIR}/__shader.cpp "#pragma once\n")
	file(APPEND ${CMAKE_CURRENT_BINARY_DIR}/__shader.cpp "// This file is auto-generated by cmake\n\n")
	foreach(SPVGEN_CURRENT_FILE ${SPVGEN_FILES})
		...
		file(APPEND ${CMAKE_CURRENT_BINARY_DIR}/__shader.cpp "#include \"${SPVGEN_CURRENT_FILE}.hpp\"\n")
	...
	endforeach()
	target_sources(${SPVGEN_LIB_NAME} PRIVATE ${CMAKE_CURRENT_BINARY_DIR}/__shader.cpp)
