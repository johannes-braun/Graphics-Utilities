...
function(create_spirv target_name source_dir header_output namespace)
	...
	foreach(file ${gfx_current_frag} ${gfx_current_vert} ${gfx_current_geom} ${gfx_current_tese} ${gfx_current_tesc} ${gfx_current_comp})
		...
		file(RELATIVE_PATH full_unrelative_file ${CMAKE_CURRENT_SOURCE_DIR}/ ${file})
		...
		string(REGEX REPLACE "[- .\\/]" "_" full_unrelative_file ${full_unrelative_file})
		...
		if(current_dir)
			...
			set(namespace_output "${namespace_output}    namespace ${iter_list} { dynamic_export std::vector<uint32_t> ${full_unrelative_file} = @${full_relative_file}@\\\; }\n")
		else()
			set(namespace_output "${namespace_output}    dynamic_export std::vector<uint32_t> ${full_unrelative_file} = @${full_relative_file}@\\\;\n")
		endif()
