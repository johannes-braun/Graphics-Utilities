...
#define VK_OEM_CLEAR      0xFE
    ...
    using drop_fun = void(const files::path&);
    ...
    public:
        ...
        std::wstring get_clipboard() const;
        void set_clipboard(const std::wstring& data) const;

#ifndef WIN32_WINDOW_PUBLIC_CALLBACKS
    private:
#else
    public:
#endif
        ...
        void on_key(int key, bool down, bool ctrl, bool alt, bool shift) const;
        void on_char(wchar_t c, bool ctrl, bool alt, bool shift) const;

#ifndef WIN32_WINDOW_PUBLIC_HANDLES
    private:
#else
    public:
#endif
