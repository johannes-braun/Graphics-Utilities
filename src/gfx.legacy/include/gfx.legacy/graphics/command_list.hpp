...
public:
    ...
    virtual void set_viewports(u32 first, gsl::span<viewport> vp, gsl::span<rect2f> scissors) = 0;
...
public:
	...
	void set_viewports(u32 first, gsl::span<viewport> vp, gsl::span<rect2f> scissors) const;
