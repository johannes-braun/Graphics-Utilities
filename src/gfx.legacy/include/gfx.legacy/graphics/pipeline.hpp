...
public:
    ...
    virtual void   initialize(const pipe_state& state, const renderpass_layout& renderpass, gsl::span<const v1::shader* const> shaders) = 0;
...
public:
    ...
    graphics_pipeline(const pipe_state& state, const renderpass_layout& renderpass, gsl::span<const v1::shader* const> shaders);
};
