...
public:
	...
	device_image_implementation(device_image_implementation&& other) noexcept = default;
	device_image_implementation& operator=(device_image_implementation&& other) noexcept = default;
...
private:
    movable_handle<mygl::texture> _handle;
