...
format_info format_from(format format)
{
	...
	case bgra8unorm: return {GL_RGBA8, GL_BGRA, GL_UNSIGNED_BYTE, true, GL_COLOR_BUFFER_BIT};
	case bgr8unorm: return {GL_RGB8, GL_BGR, GL_UNSIGNED_BYTE, true, GL_COLOR_BUFFER_BIT};
