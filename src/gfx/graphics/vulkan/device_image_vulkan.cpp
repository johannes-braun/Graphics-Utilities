                                             ...
                                             sample_count samples)
{
	...
	_transfer_pool = impl->command_pools()[fam::graphics];
	_transfer_queue = impl->queues()[fam::graphics];
    ...
    img_create.usage = VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT;
	...
	case d32fs8ui:
		...
		break;
	default:
		img_create.usage |= VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT;
		break;
    }
...
void device_image_implementation::fill_from(const host_image& image, uint32_t level, uint32_t layer)
{
	...
	vkCmdPipelineBarrier(cmd, VK_PIPELINE_STAGE_HOST_BIT, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_DEPENDENCY_BY_REGION_BIT, 0, nullptr, 0, nullptr, 1, &imembarr);
	...
	vkCmdPipelineBarrier(cmd, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, VK_DEPENDENCY_BY_REGION_BIT, 0, nullptr, 0, nullptr, 1, &imembarr);
...
void device_image_implementation::fill_to(const host_image& image, uint32_t level, uint32_t layer)
{
	...
	imembarr.subresourceRange.baseMipLevel = level;
	imembarr.subresourceRange.levelCount = 1;
	vkCmdPipelineBarrier(cmd, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_DEPENDENCY_BY_REGION_BIT, 0, nullptr, 0, nullptr, 1, &imembarr);
...
std::any device_image_implementation::api_handle() { return _image; }
...
void device_image_implementation::generate_mipmaps()
{
	...
	vkCmdPipelineBarrier(cmd, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_DEPENDENCY_BY_REGION_BIT, 0, nullptr, 0, nullptr, 1, &initial);
	...
	for (u32 layer = 0; layer < _layers; ++layer)
	{
		for (u32 i = 1; i < _levels; ++i)
		{
			...
			vkCmdPipelineBarrier(cmd, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_DEPENDENCY_BY_REGION_BIT, 0, nullptr, 0, nullptr, 1, &initial);
			...
			vkCmdPipelineBarrier(cmd, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_DEPENDENCY_BY_REGION_BIT, 0, nullptr, 0, nullptr, 1, &ending);
		}
	}
	...
	vkCmdPipelineBarrier(cmd, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, VK_DEPENDENCY_BY_REGION_BIT, 0, nullptr, 0, nullptr, 1, &initial);
