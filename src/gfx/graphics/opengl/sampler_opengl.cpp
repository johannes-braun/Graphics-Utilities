...
void sampler_implementation::set_wrap(wrap w, wrap_mode mode)
{
    ...
    {
    case wrap::u:
        glSamplerParameteri(_handle, GL_TEXTURE_WRAP_R, wm);
        break;
    case wrap::v:
        glSamplerParameteri(_handle, GL_TEXTURE_WRAP_S, wm);
        break;
    case wrap::w:
        glSamplerParameteri(_handle, GL_TEXTURE_WRAP_T, wm);
        break;
    default:
        break;
    }
...
void sampler_implementation::set_compare(bool enable, compare_op op)
{
    ...
    case compare_op::never:
        glSamplerParameteri(_handle, GL_TEXTURE_COMPARE_FUNC, GL_NEVER);
        break;
    case compare_op::less:
        glSamplerParameteri(_handle, GL_TEXTURE_COMPARE_FUNC, GL_LESS);
        break;
    case compare_op::equal:
        glSamplerParameteri(_handle, GL_TEXTURE_COMPARE_FUNC, GL_EQUAL);
        break;
    case compare_op::less_or_equal:
        glSamplerParameteri(_handle, GL_TEXTURE_COMPARE_FUNC, GL_LEQUAL);
        break;
    case compare_op::greater:
        glSamplerParameteri(_handle, GL_TEXTURE_COMPARE_FUNC, GL_GREATER);
        break;
    case compare_op::not_equal:
        glSamplerParameteri(_handle, GL_TEXTURE_COMPARE_FUNC, GL_NOTEQUAL);
        break;
    case compare_op::greater_or_equal:
        glSamplerParameteri(_handle, GL_TEXTURE_COMPARE_FUNC, GL_GEQUAL);
        break;
    case compare_op::always:
        glSamplerParameteri(_handle, GL_TEXTURE_COMPARE_FUNC, GL_ALWAYS);
        break;
    default:
        break;
    }
