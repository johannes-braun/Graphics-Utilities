...
class device;
namespace impl {
class vk_mesh_proxy : public mesh_allocator::proxy
{
public:
    vk_mesh_proxy(device& gpu);
...
class vk_proxy : public prototype_instantiator<InstanceInfo>::proxy, public vk_mesh_proxy
{
public:
