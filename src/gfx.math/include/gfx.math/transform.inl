...
namespace gfx
{
    ...
    inline transform::transform(const glm::mat4& mat) noexcept
    {
    ...
    inline transform::operator glm::mat4() const noexcept
    {
    ...
    inline glm::mat4 transform::matrix() const noexcept
    {
