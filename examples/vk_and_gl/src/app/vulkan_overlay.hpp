...
struct overlay_pass
{
    overlay_pass(gfx::vulkan::device& gpu, std::uint32_t images, vk::Extent2D size) : _gpu(&gpu), size(size)
    {
        ...
        vk::Sampler                       imm_samplers[] = {blur_sampler.get(), blur_sampler.get()};
        vk::DescriptorSetLayoutBinding    inbinding(0, vk::DescriptorType::eCombinedImageSampler, 2, vk::ShaderStageFlagBits::eFragment,
                                                 imm_samplers);
    ...
    void render(gfx::vulkan::commands& cmd, std::uint32_t image, vk::Image input_base, vk::ImageView input, vk::Image input_base2,
                vk::ImageView input2, vk::ImageLayout dst_layout,
                vk::AccessFlagBits dst_access)
    {
        ...
        {{nullptr, input, vk::ImageLayout::eGeneral}, {nullptr, input2, vk::ImageLayout::eGeneral}};
 ...
 /*           vk::PushConstantRange pc_range;
            ...
            const auto          fs = gfx::import_shader(shader_lib, "shaders/overlay.frag");
        ...
        struct frame_t
        {
            frame_t(gfx::vulkan::device& gpu, vk::RenderPass rpass, vk::Extent2D size)
            {
                ...
                imgc.format        = vk::Format::eR16G16B16A16Sfloat;
                ...
                imgc.usage         = vk::ImageUsageFlagBits::eColorAttachment | vk::ImageUsageFlagBits::eSampled
