...
struct gloverlay_pass
{
    gloverlay_pass(glm::ivec2 size) : size(size)
    {
    ...
    void render(mygl::texture input, mygl::texture input2)
    {
        ...
        glBindTextureUnit(1, input2);
        glBindSampler(1, tex_sampler);
