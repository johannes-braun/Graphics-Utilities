...
int main()
{
    ...
    auto               texture2 = another_image2.view(gfx::imgv_type::image2d);
    ...
    layout.binding_layouts.push_back(&push_layout);
    ...
    for (int i = 0; i < fbos.size(); ++i)
    {
        ...
        cmd3[i].push_binding(1, 0, gfx::binding_type::sampled_image, texture2, sampler);
    ...
    while (context->run())
    {
        imgui.new_frame();
        ImGui::Begin("asoidfh");
        ImGui::Button("soaidhasd");
        ImGui::Text("aspoidjjdadpao");
        ImGui::End();
