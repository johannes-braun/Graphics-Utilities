...
int main(int argc, char** argv)
{
	...
	vk::PipelineRasterizationStateCreateInfo rst_state({}, 0, 0, vk::PolygonMode::eFill, vk::CullModeFlagBits::eNone, vk::FrontFace::eCounterClockwise, false, 0.f, 0.f, 0.f, 1.f);
	...
	blend_col_att0.colorWriteMask = vk::ColorComponentFlagBits::eR | vk::ColorComponentFlagBits::eG | vk::ColorComponentFlagBits::eB | vk::ColorComponentFlagBits::eA;
	...
	vmaCreateBuffer(gpu.alloc(), reinterpret_cast<VkBufferCreateInfo*>(&buf_inf), &alloc_info, reinterpret_cast<VkBuffer*>(&buf), &alloc, &alloc_res);
