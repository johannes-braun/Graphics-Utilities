...
const gfx::buffer<gfx::index32>& mesh_allocator::index_buffer() const noexcept
{
    return *_index_buffer;
}

const gfx::buffer<gfx::vertex3d>& mesh_allocator::vertex_buffer() const noexcept
{
    return *_vertex_buffer;
}

unique_mesh mesh_allocator::allocate_mesh_unique(const gsl::span<const gfx::vertex3d>& vertices,
                                                 const gsl::span<const gfx::index32>&  indices)
{
...
const gfx::buffer<gfx::bvh<3>::node>& mesh_allocator::bvh_buffer() const noexcept
{
    return *_bvh_buffer;
}
