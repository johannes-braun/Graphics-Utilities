...
{ 
    bloom::bloom()
    {
        ...
        _blur_pipeline[GL_FRAGMENT_SHADER] = std::make_shared<gl::shader>("postfx/filter/blur.frag");
        _flare_pipeline[GL_FRAGMENT_SHADER] = std::make_shared<gl::shader>("postfx/filter/flare.frag");
        _bright_pipeline[GL_FRAGMENT_SHADER] = std::make_shared<gl::shader>("postfx/filter/bright_spots.frag");
        _add_pipeline[GL_FRAGMENT_SHADER] = std::make_shared<gl::shader>("postfx/filter/add.frag");
    }
